                  ...
                  ?>
                   <tr>
                       <td><?php echo $i ?></td>
                        ...
                        <td class="text-primary"><?php echo $row["content"] ?></td>
                       <!-- <td class="text-primary"><?php echo $row["phones"] ?></td>-->
                         ...
                         <a href="xoabaiviet.php?id=<?php echo $row["id"] ?>" class="btn btn-danger" id="btn-submit-del" type="button" onclick="myFunction()">
